...
const CODE_MESSAGES: Record<string, string> = {
  ...
  "Invoice.ShareNotAllowed": "لا تملك حق الوصول إلى هذه الفاتورة",
  "Invoice.ShareWithSelf": "لا يمكنك مشاركة الفاتورة مع نفسك",
  "Invoice.ShareWithOwner": "لا يمكن المشاركة مع مالك الفاتورة — لديه وصول بالفعل",
  "Invoice.ConcurrencyConflict": "تغييرات أحدث من مستخدم آخر — جارٍ إعادة التحميل، ثم أعد المحاولة",
  "Invoice.InvalidConcurrencyToken": "رمز التزامن غير صالح — جارٍ إعادة التحميل",
