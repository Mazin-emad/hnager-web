...
const draftSchema = z.object({
  ...
  discountPercent: z.coerce.number().min(0, "لا تقل عن 0").max(100, "لا تزيد عن 100"),
...
function statusVariant(status: InvoiceStatus): "default" | "secondary" | "destructive" {
  ...
  return (
    <div>
              ...
              <Form {...form}>
                ...
                >
                  ...
                  <DialogFooter>
                    ...
                    >
                      {createMutation.isPending ? "جارٍ الإنشاء…" : "إنشاء ومتابعة"}
                    </Button>
                  </DialogFooter>
                </form>
              </Form>
        ...
        <CardContent className="flex flex-col gap-3 pt-6 lg:flex-row lg:items-end">
          ...
          <div className="grid grid-cols-2 gap-3 sm:flex">
            <Select
              ...
              onValueChange={(v) =>
                setFilters((f) => ({ ...f, status: v as InvoiceFilters["status"], page: 1 }))
              }
            >
            ...
            <Select
              ...
              onValueChange={(v) =>
                setFilters((f) => ({ ...f, type: v as InvoiceFilters["type"], page: 1 }))
              }
            >
              <SelectTrigger className="w-full sm:w-36">
      ...
      {listQuery.isPending ? (
        ...
        <ErrorCard message={parseApiError(listQuery.error).message} onRetry={() => listQuery.refetch()} />
        ...
        <>
          ...
          <div className="mt-4 flex items-center justify-between text-sm text-muted-foreground">
            <span className="tnum">
              صفحة {filters.page ?? 1} من {totalPages} — الإجمالي {listQuery.data.totalCount}
            </span>
